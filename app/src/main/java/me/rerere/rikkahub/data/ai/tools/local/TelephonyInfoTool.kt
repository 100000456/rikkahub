...
internal fun buildTelephonyInfoTool(context: Context): Tool = Tool(
    ...
    execute = { _ ->
        ...
        try {
            ...
            val simOperator = try { tm.simOperator ?: "" } catch (e: Exception) { "" }
            val simOperatorName = try { tm.simOperatorName ?: "" } catch (e: Exception) { "" }
            val simCountryIso = try { tm.simCountryIso ?: "" } catch (e: Exception) { "" }
            val networkOperator = try { tm.networkOperator ?: "" } catch (e: Exception) { "" }
            val networkOperatorName = try { tm.networkOperatorName ?: "" } catch (e: Exception) { "" }
            val networkCountryIso = try { tm.networkCountryIso ?: "" } catch (e: Exception) { "" }
            ...
            val networkTypeNum = try {
                ...
                Logging.log("TelephonyInfoTool", "SecurityException reading dataNetworkType: ${e.message}")
                try {
            ...
            val phoneType = try { tm.phoneType } catch (e: Exception) { TelephonyManager.PHONE_TYPE_NONE }
